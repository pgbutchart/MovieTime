...
import com.team1.trivia.activities.OpeningActivity;
import com.team1.trivia.activities.TriviaActivity;
...
public class QueryBuilder extends TriviaActivity {
	...
	public QueryBuilder() {
		...
		public String getQuestions() {
			Integer count = 210; // DBHelper.getCount();
		...
		public String categories() {
			...
			for (String s: OpeningActivity.getCat()) {
